...
RSpec.feature "Create team and picks", type: :feature do
  ...
  before do
    Timecop.freeze(Time.new(2019, 12, 30))
  end
  ...
  scenario "with valid credentials" do
    ...
    new_time = Time.new(2020, 1, 1)
    Timecop.travel(new_time)
    visit current_path

    expect(page).not_to have_content('You can update your team until 31st December 2019. Click here to do so.')
    expect(page).to have_content('The team update deadline has now passed.')
  end
end
